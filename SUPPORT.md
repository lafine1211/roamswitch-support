...
`journalctl -u roamswitch -b` plus `roamswitch status` output (redacted). Install and
docs: <https://lafine.net/linux> · whitepaper: <https://lafine.net/linux/whitepaper>.
...
導入・ドキュメント: <https://lafine.net/linux> ・設計書: <https://lafine.net/linux/whitepaper>。
